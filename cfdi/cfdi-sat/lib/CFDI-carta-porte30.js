...
class CFDICartaPorte30 extends Node {
	/**
	 *
	 * @returns {*}
	 */
	...
	_makeXml(internal = false) {
		...
		xmlString = xmlString
			.replace(' xmlns:cfdi=""', '')
			// Para la carta porte
			.replace(/<cartaporte30:Mercancia>/g, '')
			.replace(/<cartaporte30:Mercancias>/g, '')
			.replace(/<\/cartaporte30:Mercancia><\/cartaporte30:Mercancia>/g, '</cartaporte30:Mercancia>')
			.replace(/<\/cartaporte30:Mercancia><\/cartaporte30:Mercancias>/g, '</cartaporte30:Mercancia>')
	...
	getDefaultAttributes() {
		let attr = {
			...
			'$xsi:schemaLocation': `http://www.sat.gob.mx/cfd/4 http://www.sat.gob.mx/sitio_internet/cfd/4/cfdv40.xsd http://www.sat.gob.mx/CartaPorte30 http://www.sat.gob.mx/sitio_internet/cfd/CartaPorte/CartaPorte30.xsd`,
...
module.exports = CFDICartaPorte30
